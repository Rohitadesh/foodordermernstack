...
const Starter = () =>{
    ...
    useEffect(()=>{
        const get_starter = async () =>{
            try{

                const response = await axios.get('http://localhost:5000/starter')
                    ...
                    return(
                        ...
                        <div key={index} className="h-full w-full  flex flex-wrap justify-center items-center">
                            <div  className='h-36 w-36    border flex flex-wrap flex-col justify-center items-center  
                                ...
                                <Image src={element1.starter_image}   alt={element1.starter_title}   loading={"lazy"} fill objectFit="cover"/>
                            </div>
                            ...
                            flex flex-col flex-wrap justify-center items-center  gap-4 shadow-xl">
                                <h1 className="text-md  text-black text-center pl-20">{element1.starter_title}</h1>
                                <h1 className="text-md  text-black text-center pl-20">Rs.{element1.starter_price}</h1>
                                <Btn />
                            </div>
                        </div>
                    )
